...
#ifdef LY_VIDEOCORE_EXPORTS
#define LY_VIDEOCORE_API __declspec(dllexport)
#else
#define LY_VIDEOCORE_API __declspec(dllimport)
#endif
...
////////////////////////////////////////   VIDEO DEVICE   ///////////////////////////////////
 ...
 class LY_VIDEOCORE_API videoDevice{
...
class LY_VIDEOCORE_API videoInput{
